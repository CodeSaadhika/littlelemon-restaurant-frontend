            ...
            <div className="row">
                <div className="col-8 m-2">
                    <div className="row Herobanner-content">
                        <div className="col-7 row flex-column Herobanner-text">
                            ...
                            <div className="col-6">
                                <NavLink to='/booking' className="button button--secondary Herobanner-cta">Reserve a Table</NavLink>
                            </div>
                        </div>
                        <div className="col-5 Herobanner-image">
